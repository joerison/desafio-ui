...
@Component({
  selector: 'app-time-mais-comum',
  templateUrl: './time-mais-comum.component.html',
  styleUrls: ['./time-mais-comum.component.css'],
...
export class TimeMaisComumComponent {
  ...
  timeMaisComum() {
    ...
    this.apiService.timeMaisComum(dataFormatada)
