...
@Component({
  selector: 'app-franquia-mais-famosa',
  templateUrl: './franquia-mais-famosa.component.html',
  styleUrls: ['./franquia-mais-famosa.component.css'],
...
export class FranquiaMaisFamosaComponent {
  ...
  franquiaMaisFamosa() {
    ...
    this.apiService.franquiaMaisFamosa(dataFormatada)
