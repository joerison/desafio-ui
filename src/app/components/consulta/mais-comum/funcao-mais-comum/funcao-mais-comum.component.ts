...
@Component({
  selector: 'app-funcao-mais-comum',
  templateUrl: './funcao-mais-comum.component.html',
  styleUrls: ['./funcao-mais-comum.component.css'],
...
export class FuncaoMaisComumComponent {
  ...
  funcaoMaisComum() {
    ...
    this.apiService.funcaoMaisComum(dataFormatada)
